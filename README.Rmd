...
To be able to use this plugin, please install R (click for [instructions](https://cran.r-project.org/)). Only R version 3.6.2 or newer can run the plugin/
...
On both mac and windows, please setup FlowJo to recognize R. [Here](http://docs.flowjo.com/d2/plugins/installing-plugins/), under "*"Installing the R statistical computing environment"*", there are easy-to-follow instructions.
