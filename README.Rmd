...
On mac and windows, download the file [**DAFi.jar**](https://github.com/PedroMilanezAlmeida/DAFi/raw/master/DAFi.jar) and copy it to FlowJo's plugin folder. More information on how to install a plugin in FlowJo can be found [here](http://docs.flowjo.com/d2/plugins/installing-plugins/).
