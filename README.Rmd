...
On mac and windows, download the **DAFi.jar** file from our [Google Drive](https://drive.google.com/drive/folders/1fdTVdbz8S_v58oPX8jpYDudL4wRAge2a) and copy the file to FlowJo's plugin folder. More information on how to install a plugin in FlowJo can be found [here](http://docs.flowjo.com/d2/plugins/installing-plugins/).
